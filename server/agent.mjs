...
function findProvider(text) {
  if (text.includes("אינסטלטור") || text.includes("גז") || text.includes("מים") || text.includes("ביוב") || text.includes("נזילה")) {
    return providers.find((provider) => provider.domain.includes("אינסטלציה"));
  }
  if (text.includes("חשמל") || text.includes("חשמלאי") || text.includes("טכנאי")) {
...
function classifyCategory(text) {
  ...
  if (text.includes("חשמל") || text.includes("נורה") || text.includes("חשמלאי") || text.includes("טכנאי")) return "electricity";
